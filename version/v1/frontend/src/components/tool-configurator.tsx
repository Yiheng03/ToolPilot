        ...
        <div className="grid lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <Card className="shadow-lg border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                {activeDetailQuote ? `基于详细规格、报价锚点和 ${TOOL_PRICE_FORMULA_VERSION} 的刀具报价结果。` : "基于市场预测和 tool_price_formula_v1 的刀具报价结果。"}
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Dialog open={isQuoteDialogOpen} onOpenChange={setIsQuoteDialogOpen}>
          <DialogContent className="max-h-[88vh] overflow-y-auto sm:max-w-4xl">
            <DialogHeader>
              ...
              <DialogDescription>输入产品尺寸规格后可按 {TOOL_PRICE_FORMULA_VERSION} 重新计算；留空则继续使用当前默认规格报价。</DialogDescription>
            </DialogHeader>
